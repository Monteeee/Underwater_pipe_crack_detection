...
class NetMobileFC(NetModel):
    ...
    @return:
        the model
    '''
    def __init__(self, save_path: str, image_size: int,
                 class_num: int, alpha: float):
    ...
    def callbacks(self):
        ...
        self.checkpoint = ModelCheckpoint(
            self.save_path + "/mobile/model_weight.h5",
            monitor='val_loss',
            verbose=1,
            save_best_only=True,
            mode='min',
        ...
        self.reduceLROnPlat = ReduceLROnPlateau(
            monitor='val_loss',
            factor=0.8,
            patience=10,
            verbose=1,
        ...
        self.tbCallBack = TensorBoard(
            log_dir=self.save_path + '/mobile/logs',
            histogram_freq=0,
            write_graph=True,
            write_grads=True,
            write_images=True,
        ...
        callbacks_list = [
            self.checkpoint, self.early, self.reduceLROnPlat, self.tbCallBack]
